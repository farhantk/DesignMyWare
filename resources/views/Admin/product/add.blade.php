                            ...
                            <div class="card-body">
                                <form action="{{route('admin.product.create')}}" method="post">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nama Produk" aria-label="Nama" aria-describedby="basic-addon1" name="name">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1" style="width:150px;">Varian</span>
                                        <input type="text" class="form-control" placeholder="Varian ID" aria-label="Varian" aria-describedby="basic-addon1" name="variant_id">
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" style="width:150px;">Deskripsi Produk</span>
                                        <textarea class="form-control" placeholder="Deskripsi Produk" aria-label="With textarea" name="desc"></textarea>
                                    </div>
                                    <div class="input-group mb-3">
                                        <span class="input-group-text" id="basic-addon1" style="width:150px;">Harga</span>
                                        <input type="text" class="form-control" placeholder="Harga Produk" aria-label="Harga" aria-describedby="basic-addon1" name="price">
                                    </div>
