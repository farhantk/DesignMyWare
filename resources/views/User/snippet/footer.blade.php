<footer class="bg-third pt-24 pb-5">
    <div class="container px-32">
        <div class="flex flex-wrap">
            <div class="w-full px-4 mb-12 text-slate-300 font-medium md:w-1/3">
                <h2 class="text-white font-bold text-4xl mb-5">Design My Ware</h2>
                <h3 class="text-bold text-2xl mb-2">Hubungi Kami</h3>
                <p>contact@designmyware.com</p>
                <p>Jl. Soekarno Hatta No. 111</p>
                <p>Bandung, Jawa Barat</p>
                <div class="flex items-center pt-10">
                    <!--Youtube-->
                    <a href="https://www.youtube.com/channel/UCIj4JeQbqKggYExcBXFGXGw" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                    ...
                    <!--Instagram-->
                    <a href="https://www.instagram.com/tirtafarhn/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                    ...
                    <!--Github-->
                    <a href="https://github.com/farhantk" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
                    ...
                    <!--Linkedin-->
                    <a href="https://www.linkedin.com/in/farhan-tirta-kesumah-bb9344219/" target="_blank" class="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-slate-300 text-slate-300 hover:border-primary hover:bg-primary hover:text-white">
